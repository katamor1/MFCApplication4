...
static const KEY_INFO g_KeyLayout[5][15] = {
    ...
    {   {IDC_KEY_BASE + 0,  _T("Esc"),    _T(""),      VK_ESCAPE,   KT_ACTION,   1},
        ...
        {IDC_KEY_BASE + 14, _T("Del"),    _T(""),      VK_DELETE,   KT_ACTION,   1}
    },
    // Row 2
    ...
    {   {IDC_KEY_BASE + 30, _T("Caps"),   _T(""),      VK_CAPITAL,  KT_MODIFIER, 2},
        ...
        {IDC_KEY_BASE + 39, _T("l"),      _T("L"),     'L',         KT_NORMAL,   1},
    ...
    {   {IDC_KEY_BASE + 43, _T("Shift"),  _T(""),      VK_LSHIFT,   KT_MODIFIER, 3},
        ...
        {0,}, {0,}, {0,} // Span placeholders
    },
    // Row 5
    {   {IDC_KEY_BASE + 55, _T("Ctrl"),   _T(""),      VK_LCONTROL, KT_MODIFIER, 2},
        ...
        {IDC_KEY_BASE + 60, _T("Ctrl"),   _T(""),      VK_RCONTROL, KT_MODIFIER, 2},
        {0,}, {0,}, {0,}, {0,}, {0,}, {0,}, {0,}, {0,}, {0,} // Span placeholders
    }
};